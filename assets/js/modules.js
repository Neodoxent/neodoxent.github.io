/* ==================================================
   ...
   These are not game currencies. They are interpretive
   capacities required for deeper access.
   ================================================== */
...
window.NEODOXENT_MODULES = [
  ...
  },
  {
    ...
    grants: { bits: 2, strata: { semiotic: 1 }, qbits: { symbolic: 2, poetic: 1 }, resources: { signal: 2 }, vector: "cardinal" }
  },
  {
    id: "glyphs",
    ...
    grants: { bits: 2, strata: { semiotic: 1 }, qbits: { symbolic: 2, cognitive: 1 }, resources: { signal: 1, trace: 1 }, vector: "glyphic" }
  },
  {
    id: "regalia",
    ...
    grants: { bits: 2, strata: { regal: 1 }, qbits: { regal: 2, poetic: 1 }, resources: { witness: 1 }, vector: "regal" }
  },
  {
    id: "atlas",
    title: "Atlas Layer",
    ...
    grants: { bits: 2, entanglement: 1, strata: { cartographic: 1 }, qbits: { architectural: 2 }, resources: { trace: 1 }, vector: "architect" }
  },
  {
    ...
    grants: { bits: 3, coherence: 1, qbits: { cognitive: 2, architectural: 1 }, resources: { attention: 1 }, vector: "complexity" }
  },
  {
    ...
    grants: { bits: 3, entanglement: 1, strata: { cybernetic: 1 }, qbits: { cybernetic: 3 }, resources: { signal: 1, trace: 1 }, vector: "cybernetic" }
  },
  {
    id: "frameworks",
    ...
    grants: { bits: 3, coherence: 1, qbits: { architectural: 3, cybernetic: 1 }, resources: { trace: 1 }, vector: "framework" }
  },
  {
    id: "drunemeton",
    ...
    grants: { bits: 4, strata: { cathedral: 1 }, qbits: { cathedral: 3, regal: 1 }, resources: { witness: 2 }, vector: "cathedral" }
  },
  {
    id: "cathedral",
    ...
    grants: { bits: 6, strata: { cathedral: 2 }, qbits: { cathedral: 6 }, resources: { trace: 3 }, vector: "cathedral" }
  }
];
